...
double dot_vector(double* x, double* y, size_t n) {
    size_t i = 0;
    double sum = 0;
...
#ifdef VECTORIZE
void* bench_dot_vector(void* arg) {
    test_args_t* targ = (test_args_t*)arg;
    *(targ->result) = dot_vector(targ->x, targ->y, targ->n);
    return NULL;
}
#endif
...
#define _L 10
    ...
    #ifdef VECTORIZE
    printf("Vector     : ");
    benchmark(bench_dot_vector, (void*)(&arg), _N, _L, 0b01, NULL);
    #endif
    printf("OPENMP     : ");
